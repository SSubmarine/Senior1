...
<body>
	...
	<div class="slideshow-container" id="promotion">
		...
		<div class="mySlides fade">
			<img src="img/promotion2.jpg" style="width: 1000px; height: 400px;">
		</div>
	...
	<div class="w3-content w3-container w3-padding-64" id="room">
		...
		<div class="w3-row-padding w3-center">
			...
			<div class="w3-col m3">
				<img src="${room.roomPic}" style="width: 100%"
					onclick="onClick(this)" class="w3-hover-opacity"
					alt="${room.roomType} ${room.roomDetail}">
			</div>
			</c:forEach>
		</div>
	</div>
...
-->
	...
	<!-- popup1 login end-->
	<!-- popup2 #statusChecking start -->
	<div id="#popupCheck" class="overlayPopup">
		<div class="popup">
			<a class="close" href="#">&times;</a>
			<div class="w3ls-main">
										...
										<form action="#" method="post">
											<div class="icon1">
												<i class="fa fa-credit-card-alt" aria-hidden="true"></i> <input
													type="text" placeholder="Enter your BookReq" required="" />
											</div>
											<div class="icon1">
												<i class="fa fa-user" aria-hidden="true"></i> <input
													type="text" placeholder="Enter your pic" required="" />
											</div>
