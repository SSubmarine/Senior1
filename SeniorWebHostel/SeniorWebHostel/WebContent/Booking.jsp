...
<body class="bgimg">
	...
	<div class="w3-top">
		<div class="w3-bar" id="myNavbar">
			...
			</a> <a href="home.do" class="w3-bar-item w3-button">HOME</a> <a
				href="#popupLogin"
			...
			</a> <a href="home.do" class="w3-bar-item w3-button w3-hide-small w3-right">
		...
		<div id="navDemo"
			...
			<a href="#home.do" class="w3-bar-item w3-button">HOME</a> <a
				href="#popupLogin"
				class="w3-bar-item w3-button w3-hide-small w3-right"> <i
				class="fa fa-user"></i> Log In
			</a> <a href="home.do"
										...
										<div class="from-group">
											...
											<div class="input-prepend input-group">
												<span class="add-on input-group-addon"> <i
													...
													id="reservation" class="form-control" type="text"
																		...
																		<div class="pricing_features">
																			<ul class="list-unstyled text-left">
																				...
																				<li><img src="${product.productPic}"
																					width="200" height="150" /></i></li>
																			</ul>
																		</div>
																	</div>
																	<div class="pricing_footer">
																		<a id="${product.productId}" onClick="select(this); return false;" 
																			class="btn btn-success btn-block" role="button"
																			data-todo='{"productId":"${product.productId}","productName":"${product.productName}","productPrice":"${product.productPrice}"}'
																			type="submit"><span>${product.productPrice} Baht</span>
																		</a>
																	...
																	<div class="">
																		<div class="pricing_features">
																			<ul class="list-unstyled text-left">
																				<li><i class="fa fa-times text-success"></i>
																					${trip.tripDetail}</li>
																				<li><img src="${trip.tripPic}" width="200"
																					height="150" /></i></li>
																			</ul>
																		</div>
																	</div>
																	<div class="pricing_footer">
																		<a id="${trip.tripId}" onClick="select(this); return false;"
																			data-todo='{"productId":"${trip.tripId}","productName":"${trip.tripName}","productPrice":"${trip.tripPrice}"}'
																			class="btn btn-success btn-block" role="button"
																			type="submit"> <span>${trip.tripPrice} Baht</span>
																		</a>
																	</div>
																</div>
															</div>
														...
														<div class="col-md-4 col-sm-6 col-xs-12">
															<div class="pricing">
																...
																<div class="x_content">
																	<div class="">
																		<div class="pricing_features">
																			<ul class="list-unstyled text-left">
																				...
																				<li><img src="${spa.spaPic}" width="200"
																					height="150" /></i></li>
																	...
																	<div class="pricing_footer">
																		<a id="${spa.spaId}" onClick="select(this); return false;"
																			data-todo='{"productId":"${spa.spaId}","productName":"${spa.spaName}","productPrice":"${spa.spaPrice}"}'
																			class="btn btn-success btn-block" role="button">
																			<span>${spa.spaPrice} Baht</span>
																		</a>
									...
									<div class="x_content">
										...
										<form id="demo-form2" data-parsley-validate
											...
											<div class="form-group">
												...
												<div class="col-md-3 col-sm-6 col-xs-12">
													<select id="gender" class="form-control" name="age">
														<option value=""></option>
...
<button class="btn btn-default" onclick="window.print();"><i class="fa fa-print"></i> Print</button>					<script>
						function myFunction() {
							console.log('my function')
							var roomBookingDate = document
									.getElementById("reservation").value;
							document.getElementById("guestreservation").innerHTML = roomBookingDate;
							...
							document.getElementById("guestage").innerHTML = age;
...
<script src="build/js/listBooking.js"></script>
