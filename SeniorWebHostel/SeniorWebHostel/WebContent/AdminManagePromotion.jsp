...
<title>Admin Manage Promotion</title>
										...
										<tbody>
											<c:forEach items="${promotionList}" var="promotion">
												<tr>
													...
													<td><img src="${promotion.promotionPic}" width="250"
														height="250" /></td>
													<td><a onclick="myFunction()"
														class="btn btn-danger btn-xs"
														href="deletePromotion.do?id=${promotion.promotionId}"><i
	...
	<div id="CalenderModalNew" class="modal fade" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form:form method="post" action="savePromotion.do"
					...
					<div class="modal-body">
						<div id="testmodal" style="padding: 5px 20px;">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<form:input path="startDate" class="form-control" id="title"
										name="title" />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Promotion Code</label>
								<div class="col-sm-9">
									<form:input path="promotionCode" type="text"
										class="form-control" id="title" name="title/" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label">Discount Rate</label>
								<div class="col-sm-9">
									<form:input path="discountRate" type="text"
										class="form-control" id="title" name="title/" />
								</div>
							</div>
							<div class="form-group">
