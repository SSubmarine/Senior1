...
<body class="nav-md">
										...
										<tbody>
											<c:forEach items="${roomList}" var="room">
												<tr>
													...
													<td><img src="${room.roomPic}" width="250" height="250" /></td>
													<td><a class="btn btn-info btn-xs" data-toggle="modal" id="${room.roomId}" data-todo='{"roomId": "${room.roomId}","roomType": "${room.roomType}", "roomDetail": "${room.roomDetail}","roomPic": "${room.roomPic}"}'
														href="#CalenderModalEdit" onClick="editModal(${room.roomId})"><i
															...
															<script>
																function editModal(id) {
																		...
																		document.getElementById("roomDetail").value = data.roomDetail
																		//document.getElementById("files").value = roomPic[1]
																	}
															</script>
															 <a onclick="myFunction()"
														class="btn btn-danger btn-xs"
														href="deleteRoom.do?id=${room.roomId}"><i
					...
					<div class="modal-body">
						<div id="testmodal" style="padding: 5px 20px;">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<form:input path="roomType" type="text" class="form-control"
										id="title" name="title" />

								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label">Room Detail</label>
								<div class="col-sm-9">
									<form:input path="roomDetail" type="text" class="form-control"
										id="title" name="title" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label">Room Picture</label>
								<div class="col-sm-9">
	...
	<div id="CalenderModalEdit" class="modal fade" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form:form method="post" action="updateRoom.do" commandName="room"
					enctype="multipart/form-data">
