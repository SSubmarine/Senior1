				...
				<div class="">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>Management Order Product</h2>
										...
										<tbody>
											<c:forEach items="${orderProductList}" var="orderProduct">
												<tr>
													...
													<td>${orderProduct.orderProductDate}</td>
													<td>${orderProduct.productPrice}</td>
													<td>${orderProduct.productUnit}</td>
													<td><a onclick="myFunction()"
														class="btn btn-danger btn-xs"
														href="deleteOrderProduct.do?id=${orderProduct.orderProductId}"><i
