										...
										<tbody>
											<c:forEach items="${tripList}" var="trip">
												<tr>
													...
													<td><img src="${trip.tripPic}" width="250"
														height="250" /></td>
					...
					<div class="modal-body">
						<div id="testmodal" style="padding: 5px 20px;">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<form:input path="tripName" type="text" class="form-control"
										id="title" name="title" />
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<form:input path="tripDetail" type="text" class="form-control"
										id="title" name="title" />
								</div>
							</div>
								<div class="form-group">
								<label class="col-sm-3 control-label">Trip price</label>
								<div class="col-sm-9">
									<form:input path="tripPrice" type="text" class="form-control"
										id="title" name="title" />
								</div>
							</div>
							<div class="form-group">
