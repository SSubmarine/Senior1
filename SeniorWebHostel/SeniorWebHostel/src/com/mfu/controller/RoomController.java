...
public class RoomController {
	...
	public String save(@ModelAttribute("room") Rooms room, BindingResult result, HttpServletRequest request) {
		try {
			if (room.getRoomId() == 0) {
	...
	public String save(@RequestParam("files") CommonsMultipartFile files, Rooms room, BindingResult result,
