										...
										<tbody>
											<c:forEach items="${productList}" var="product">
												<tr>
													...
													<td><img src="${product.productPic}" width="250"
														height="250" /></td>
													<td><a class="btn btn-info btn-xs" data-toggle="modal"
														...
														href="deleteProduct.do?id=${product.productId}"><i
	...
	<div id="CalenderModalNew" class="modal fade" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form:form method="post" action="saveProduct.do" commandName="product"
					...
					<div class="modal-body">
						<div id="testmodal" style="padding: 5px 20px;">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<form:input path="productDetail" type="text" class="form-control"
										id="title" name="title" />
								</div>
							</div>
							<div class="form-group">
