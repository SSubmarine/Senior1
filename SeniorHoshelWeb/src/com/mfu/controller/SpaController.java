...
public class SpaController {
	...
	@RequestMapping("/saveSpas")
	public String save(@ModelAttribute("spa") Spa spa, BindingResult result, HttpServletRequest request){
		try {
			if (spa.getSpaId() == 0){
...
/*	@RequestMapping("/editSpa")
	...
	*/
	...
	// Test upload spa photo
	 ...
	 public String save(@RequestParam("files") CommonsMultipartFile files, Spa spa,
