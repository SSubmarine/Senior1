											...
											<c:forEach items="${productList}" var="product">
												<tr>
													...
													<td><a class="btn btn-info btn-xs" data-toggle="modal"
														data-target="#CalenderModalEdit${product.productId}"><i
															class="fa fa-pencil"></i> Edit</a> <a onclick="myFunction()"
														class="btn btn-danger btn-xs"
														href="deleteProduct.do?id=${product.productId}"><iclass="fafa-trash-o">
															</i> Delete </a> <script>
																function myFunction() {
																	alert("DELET SUCCESS!");
																}
												...
												<div id="CalenderModalEdit${product.productId}"
													class="modal fade" tabindex="-1" role="dialog"
													aria-labelledby="myModalLabel" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															<form:form method="post" action="saveProduct.do"
																commandName="product">
																...
																<div class="modal-footer">
																	<button type="submit" value="Save"
																		class="btn btn-primary antosubmit">Save</button>
																</div>
															</form:form>
														</div>
													</div>
				...
				<form:form method="post" action="saveProduct.do"
					...
					<div class="modal-body">
						<div id="testmodal" style="padding: 5px 20px;">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Product Detail</label>
								<div class="col-sm-9">
									<form:input class="form-control" path="productDetail" />
								</div>
							</div>
							<div class="form-group">
	...
	<%-- 	<div id="CalenderModalEdit" class="modal fade" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form:form method="post" action="saveProduct.do"
					commandName="product">
					<form:hidden path="productId" value="${editProduct}"/>
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
