										...
										<tbody>
											<c:forEach items="${tripList}" var="trip">
												<tr>
													<td>${trip.tripId}</td>
													<td>${trip.tripName}</td>
													<td>${trip.tripDetail}</td>
													<td>Picture</td>
													<td><a class="btn btn-info btn-xs" data-toggle="modal"
														data-target="#CalenderModalEdit"><i
															class="fa fa-pencil"></i> Edit
													</a> <a onclick="myFunction()" class="btn btn-danger btn-xs"
														href="deleteTrip.do?id=${trip.tripId}"><i
	...
	<div id="CalenderModalNew" class="modal fade" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form:form method="post" action="saveTrip.do" commandName="trip">
						...
						<div id="testmodal" style="padding: 5px 20px;">
							<form id="antoform" class="form-horizontal calender" role="form">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
								 <form:input path="tripName" type="text" class="form-control" id="title" name="title"/>
										
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">Trip Detail</label>
									<div class="col-sm-9">
										<form:input path="tripDetail" type="text" class="form-control" id="title"
											name="title"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">Promotion Picture</label>
									<div class="col-sm-9">
					...
					<div id="testmodal" style="padding: 5px 20px;">
						<form id="antoform" class="form-horizontal calender" role="form">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Trip Detail</label>
								<div class="col-sm-9">
									<form:input path="tripDetail"type="text" class="form-control" id="title" name="title"/>
								</div>
							</div>
							<div class="form-group">
