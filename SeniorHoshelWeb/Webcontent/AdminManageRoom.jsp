										...
										<tbody>
											<c:forEach items="${roomList}" var="room">
												<tr>
													...
													<td><img src="${room.roomPic}" width="250"
														height="250" /></td>
					...
					<div class="modal-body">
						<div id="testmodal" style="padding: 5px 20px;">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<form:input path="roomType" class="form-control" id="title"
										name="title" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<form:input path="roomDetail" class="form-control" id="title"
										name="title" />
								</div>
							</div>
