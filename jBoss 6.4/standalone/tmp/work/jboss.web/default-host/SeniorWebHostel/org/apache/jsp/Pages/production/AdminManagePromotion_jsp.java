...
public final class AdminManagePromotion_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("<title>Admin Manage Promotion</title>\n");
      out.write("\n");
      out.write("<!-- Bootstrap -->\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<h2>Manage Promotion</h2>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<thead>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>PromotionId</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>StartDate</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>EndDate</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>Promotion Code</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>Discount Rate</th>\n");
      ...
      out.write("\t\t\t\t\t<h4 class=\"modal-title\" id=\"myModalLabel\">Edit Promotion</h4>\n");
      out.write("\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<label class=\"col-sm-3 control-label\">PromotionId</label>\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"col-sm-3 control-label\">StartDate</label>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-sm-9\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"title\" name=\"title\">\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"col-sm-3 control-label\">EndDate</label>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-sm-9\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"title\" name=\"title\">\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"col-sm-3 control-label\">Promotion Code</label>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-sm-9\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"title\" name=\"title\">\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(PageContext _jspx_page_context)
    ...
    // /Pages/production/AdminManagePromotion.jsp(103,11) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true deferredMethod = false expectedTypeName = java.lang.Object methodSignature = null 
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/Pages/production/AdminManagePromotion.jsp(103,11) '${promotionList}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${promotionList}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /Pages/production/AdminManagePromotion.jsp(103,11) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t<tr>\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${promotion.promotionId}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("</td>\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${promotion.startDate}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("</td>\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${promotion.endDate}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("</td>\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${promotion.promotionCode}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("</td>\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${promotion.discountRate}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("</td>\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>picture</td>\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td><a onclick=\"myFunction()\"\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"btn btn-danger btn-xs\"\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\thref=\"deletePromotion.do?id=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${promotion.promotionId}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("\"><i\n");
  ...
  private boolean _jspx_meth_form_005fform_005f0(PageContext _jspx_page_context)
    ...
    // /Pages/production/AdminManagePromotion.jsp(144,4) name = method type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_form_005fform_005f0.setMethod("post");
    // /Pages/production/AdminManagePromotion.jsp(144,4) name = action type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_form_005fform_005f0.setAction("savePromotion.do");
    // /Pages/production/AdminManagePromotion.jsp(144,4) name = commandName type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_form_005fform_005f0.setCommandName("promotion");
    ...
    try {
      ...
      if (_jspx_eval_form_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\t\t\t\t\t\t<h4 class=\"modal-title\" id=\"myModalLabel\">Add Promotion</h4>\n");
          out.write("\t\t\t\t\t</div>\n");
          out.write("\t\t\t\t\t<div class=\"modal-body\">\n");
          out.write("\t\t\t\t\t\t<div id=\"testmodal\" style=\"padding: 5px 20px;\">\n");
          out.write("\n");
          ...
          out.write("\t\t\t\t\t\t\t</div>\n");
          out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
          out.write("\t\t\t\t\t\t\t\t<label class=\"col-sm-3 control-label\">Discount Rate</label>\n");
          out.write("\t\t\t\t\t\t\t\t<div class=\"col-sm-9\">\n");
          out.write("\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_form_005finput_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    // /Pages/production/AdminManagePromotion.jsp(157,9) name = path type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_form_005finput_005f0.setPath("startDate");
    // /Pages/production/AdminManagePromotion.jsp(157,9) null
    _jspx_th_form_005finput_005f0.setDynamicAttribute(null, "class", "form-control");
    // /Pages/production/AdminManagePromotion.jsp(157,9) name = id type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_form_005finput_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    // /Pages/production/AdminManagePromotion.jsp(164,9) name = path type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_form_005finput_005f1.setPath("endDate");
    // /Pages/production/AdminManagePromotion.jsp(164,9) null
    ...
    // /Pages/production/AdminManagePromotion.jsp(164,9) name = id type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_form_005finput_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    // /Pages/production/AdminManagePromotion.jsp(171,9) name = path type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_form_005finput_005f2.setPath("promotionCode");
    // /Pages/production/AdminManagePromotion.jsp(171,9) null
    ...
    // /Pages/production/AdminManagePromotion.jsp(171,9) name = id type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_form_005finput_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    // /Pages/production/AdminManagePromotion.jsp(178,9) name = path type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_form_005finput_005f3.setPath("discountRate");
    // /Pages/production/AdminManagePromotion.jsp(178,9) null
    ...
    // /Pages/production/AdminManagePromotion.jsp(178,9) name = id type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
